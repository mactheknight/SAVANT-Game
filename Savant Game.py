...
def startRoom():
    ...
    userInput = raw_input()
    if userInput == "get shield" or "shield":
...
if userInput2 == "examine wall" or "wall":
...
if userInput4 == "west":
    ...
    if userInput1 == "use torch":
        print "You see a creature, the creature sees you."
        if userInput1 == "put out torch":
            print "The creature has forgotten you. You sneak past him quietly into the next room and a stone door permanently seals the path you came from, leaving you in a room with seemingly no exits."
        else: 
...
if userInput5 == "up":
    ...
    print "She is unconscious. Before you can make any movement, everything becomes pitch black once again as you have been snatched into the jaws of Emrys."
    print "GAME OVER."
else: 
